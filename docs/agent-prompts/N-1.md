...
Goal: Complete ticket N-1 — Browser Gateway skeleton (Fastify + Playwright) in this repository with minimal guidance.
...
- Create a new branch: feat/n-1-auto, commit changes.
