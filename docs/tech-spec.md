...
- **web_research**: navigate `site-kb` pages, extract an answer (e.g., “One advantage of PGVector”). Grader checks substring/regex.
...
- **Shock @ hour 12:** change category weights (↑ web_research), increase message & browser step cost by 50%.
...
_(Stretch)_: Embedding‑based grading; LangGraph.js planner; A2A HTTP bridge; external ADK agent competitor.
